...
knowledge point:
1.HttpUtil.toParam()   this method can trans map of parameter into string which can be added to url directly
2.PrintWriter(client.getOutPutStream) can deliver the request to the host
 */
