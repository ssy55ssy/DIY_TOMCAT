...
import cn.felix.diytomcat.catalina.Connector;
import cn.felix.diytomcat.catalina.Context;
import cn.felix.diytomcat.catalina.Engine;
import cn.felix.diytomcat.catalina.Service;
...
public class Request extends BaseRequest{
    ...
    // parameterMap is used to store parameter information
    private Map<String,String[]> parameterMap;
    // headerMap is used to store head information
    private Map<String,String> headerMap;
    private Cookie[] cookies;
    private HttpSession session;
    private Connector connector;
    // forward means whether the current request is forwarded.
    private boolean forward;
    // attributesMap is used to pass attribute when server jump
    ...
    public Request(Socket socket, Connector connector) throws IOException {
        ...
        parseHttpRequest();
        // if the requestString is empty, return
        ...
        if(!"/".equals(context.getPath())){
            // judge whether need to use the welcome file
    ...
    // parse parameters and store them in the map, so users can use request.getParameter()
