...
import static cn.felix.diytomcat.util.Constant.webXmlFile;
...
public class WebXMLUtil {
	...
	//Get the mimeType according to the suffix name. The first call will be initialized. If no corresponding one is found, it will return "text/html" by default
	...
	//Prepare a tool class to obtain the name of the welcome file under a certain Context
