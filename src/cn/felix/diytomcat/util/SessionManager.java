...
public class SessionManager {
    ...
    static{
        // start checking whether sessions in sessionMap has been expired
        startSessionOutdateCheckThread();
    }

    // set the expiration time of the session from web.xml
    ...
    // cookie should have an attribute which name JSESSIONID
